...
# get SLAHMR data
python run_opt.py data=expi run_opt=True run_vis=True data.overwrite=False data.root=/home/nugrinovic/code/CVPR_2024/slahmr/videos/expi/acro1 data.seq="${action}_${cam}" data.seq_id="${subj}"
