...
def run_vis(
    ...
    **kwargs,
    ...
    if len(phase_results) > 0:
        ...
        if 0:
            root = "/sailhome/nugrinov/code/CVPR_2024/slahmr_release/slahmr/"
            os.getcwd()
            p_id=1
            idx = 40
            seq_name = dataset.seq_name
            joints = scene_dict["joints"]
            jts_this = joints[p_id, idx]
            save_pointcloud(jts_this, f"{root}/inspect_out/slahmr/prep_eval/{seq_name}/joints/joints_{idx}_{p_id}.ply")
