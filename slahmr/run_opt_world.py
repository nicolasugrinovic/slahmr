"""
This is based on slahmr/slahmr/run_opt.py
to launch run_vis_world.py
and to generate the scene-dict files for MultiPhys
"""
import os
import glob
import json
...
# NOTE: this is modified from the original slahmr/data/dataset.py
from data import get_dataset_from_cfg_w_check, expand_source_paths
...
# NOTE: this is modified from slahmr/run_opt.py
from run_vis_world import run_vis
...
def main(cfg: DictConfig):
    ...
    dataset = get_dataset_from_cfg_w_check(cfg, check_sources=False)
